...
@Configuration
public class RaqsoftAutoConfig {

    @Value("${raqsoft-config-file}")
    private String reqsoftConfigFile;
...
/*    @Bean
    ...
    public ServletRegistrationBean reportServlet() {
        ...
        reg.setLoadOnStartup(1);
        reg.addInitParameter("configFile", reqsoftConfigFile);
        reg.addInitParameter("headless", "none");
        reg.addUrlMappings("/reportServlet");
        ServletMappings.mappings.put(ReportServlet.class.getName(), "/reportServlet");
        return reg;
    }
    ...
    public ServletRegistrationBean inputServlet() {
        ...
        ServletMappings.mappings.put(InputServlet.class.getName(), "/InputServlet");
        return reg;
    }
    ...
    public ServletRegistrationBean weixinLoginServlet() {
        ...
        reg.addInitParameter("config", wexinConfigFile);
